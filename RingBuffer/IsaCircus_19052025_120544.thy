...
" Trans_stm04 = 
	((SSTOP \<triangle> (get_v1\<^bold>?v1 \<rightarrow> (assume (v1 \<ge> 1) (Trans_stm04(n)) (((((((n = NID_i0_stm04) \<^bold>& (((internal__stm04\<^bold>.NID_i0_stm04 \<rightarrow> (SSTOP \<triangle> (guar (2 \<ge> 1)(set_v1\<^bold>!2 \<rightarrow> Skip))));; (enter_s0_stm04 \<rightarrow> Trans_stm04(NID_s0_stm04)))))
	  \<box>
	  ...
	  \<box>
	  ((n = NID_s1_stm04) \<^bold>& (((a__in\<^bold>.NID_s1_stm04 \<rightarrow> Skip);; ((SSTOP \<triangle> (exit_stm04 \<rightarrow> Skip));; (SSTOP \<triangle> ((exited_stm04 \<rightarrow> Skip);; (enter_s0_stm04 \<rightarrow> Trans_stm04(NID_s0_stm04)))))))))
	  \<box>
