...
\<comment> \<open>NOT USED ANYMORE. 
   Changes from 040924 version, this version model the Bounded Buffer using fixed-point operator instead of fixrec command, the spec and   impl are defined in the same locale.
...
\<comment> \<open> changes in 0904 by Benoit from Bounded_Buffer_083024:
