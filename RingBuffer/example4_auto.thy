...
[simp del] :\<open>Trans_stm04\<cdot>n = 
	((SSTOP \<triangle> (get_v1\<^bold>?v1 \<rightarrow> (assume True (Trans_stm04\<cdot>n) (((((((n = NID_i0_stm04) \<^bold>& (((internal__stm04\<^bold>.NID_i0_stm04 \<rightarrow> (SSTOP \<triangle> (guar True (set_v1\<^bold>!1 \<rightarrow> Skip))))\<^bold>;  (enter_s0_stm04 \<rightarrow> Trans_stm04\<cdot>NID_s0_stm04))))
	  \<box>
